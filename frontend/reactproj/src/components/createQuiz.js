...
export default class createQuiz extends Component {
    ...
    handleAddQuestion = ()=>{
        ...
        tmp.push({id:this.state.lastQ+ 1, question:'',c1:'',c2:'',c3:'',c4:'', correct_answer:1})
    ...
    choice = (index, choice, correct)=>{
       ...
       return <FormControl sx={{ m: 1}} variant="outlined">
    ...
    question = ()=>{
        const info = this.state.questions[this.state.currentQ];
        return <div className='create-quiz__questions__question'>
            <h1>Question {this.state.currentQ+1}</h1>
            <div className='create-quiz__questions__question__what'>
                <TextField value={info['question']} onChange = {this.handleChange} id="question" label="Question" variant="filled" multiline rows={4} fullWidth/>
            </div>
