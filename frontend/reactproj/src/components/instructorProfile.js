            ...
            <div className='instructor-profile'>
                ...
                <div className='instructor-profile__data'>
                    ...
                    <div className='instructor-profile__info'>
                        ...
                        {this.state.editing &&
                            <div className='instructor-profile__info__username'>
                                <TextField id='username' style={{width:'100%', marginTop:'20px'}} onChange={this.handleChange} value={this.state.new_instructor.username} label="Username" variant="outlined" />
                                <TextField id='password' type='password' style={{width:'100%', marginTop:'20px'}} onChange={this.handleChange} value={this.state.new_instructor.password} label="Password" variant="outlined" />

                            </div>}
                        {!this.state.editing &&<div className='instructor-profile__info__rating'> 
                    ...
                    <div className='instructor-profile__data__footer'>
                           ...
                           {this.state.editing &&<div className='instructor-profile__data__bio'>
                                <TextField id='email' style={{width:'100%', marginTop:'20px'}} onChange={this.handleChange} value={this.state.new_instructor.email} label="Email" variant="outlined" />
