        ...
        <div className="user-course__header">
          <div className="user-course__header__left">
            ...
            <div className="user-course__header__left__summary">
              <p>
                {' '}
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed placerat diam ac
                imperdiet accumsan. Phasellus varius neque vel dolor accumsan, eget hendrerit tellus
                congue. this is a static summary because myCourse.summary is missing
              </p>
            </div>
          ...
          <div className="user-course__header__right">
            <div className="user-course__header__right__video">
              <iframe src={'https://www.youtube.com/embed/Rr3dcyN6Xdk'} title="preview"></iframe>
            </div>
          </div>
        </div>
